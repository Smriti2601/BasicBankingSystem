...
<head>
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.5.3/dist/js/bootstrap.bundle.min.js"
    ...
    crossorigin="anonymous"></script>
    <style>body {
    background-image: url("img/time.jpeg");
...
<body>
  ...
  <div id="title">
    <nav id="navbar" class="navbar navbar-expand-lg navbar-dark ">
      <a id="navbar-brand" href="index.php">Sparks Foundation<span> Task 1</span></a>
 ...
 echo '<table class=" listtable table-dark table  table-striped table-hover mt-5"  style="opacity: 0.9; width:50%; margin:auto;">
 <tr>
     <th>ID</th>
     <th>Sender</th>
     <th>Receiver</th>
